...
const COPY = {
  en: {
    eyebrow: "PREMIUM · MOBILE-11",
    title: "Premium report",
    description: "Finalize the current server-prepared Premium session as a private saved report.",
    ...
    paymentRequired: "Your server-side access currently requires Premium entitlement. This mobile slice does not add or change a payment flow.",
    ...
    privateBody: "Creating this report finalizes the existing server Premium session and saves it privately to your account. It is not published or shared.",
    ...
    paymentCreateBlocked: "The server requires Premium entitlement for this request. No payment or entitlement mutation was attempted.",
  ...
  ko: {
    eyebrow: "PREMIUM · MOBILE-11",
    title: "프리미엄 리포트",
    description: "서버가 준비한 현재 Premium 세션을 계정의 비공개 저장 리포트로 확정합니다.",
    ...
    paymentRequired: "서버 기준으로 현재 Premium 권한이 필요합니다. 이 모바일 단계에서는 결제 흐름을 추가하거나 변경하지 않습니다.",
    ...
    privateBody: "생성하면 기존 서버 Premium 세션이 확정되고 계정에 비공개로 저장됩니다. 공개 또는 공유되지 않습니다.",
    ...
    paymentCreateBlocked: "서버가 Premium 권한을 요구했습니다. 결제 또는 entitlement 변경은 시도하지 않았습니다.",
