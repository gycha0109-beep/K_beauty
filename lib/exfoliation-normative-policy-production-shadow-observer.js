...
import { buildExfoliationNormativePolicySkinMatchContext } from "./exfoliation-normative-policy-skin-match-context.js";
...
import {
  captureExfoliationNormativePolicyProductionObservation,
...
export async function observeExfoliationNormativePolicyProductionShadow({
  ...
  const productionSource = resolveExfoliationNormativePolicyProductionSource(input);
  ...
  const observation = Object.freeze({
    ...
    canonicalComparison: Object.freeze({ ...comparison }),
    legacyPathPreserved: true,
  ...
  captureExfoliationNormativePolicyProductionObservation(input, observation);
  return observation;
}
