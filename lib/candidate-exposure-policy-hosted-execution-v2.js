...
} from "./candidate-exposure-policy-hosted-diagnostic-execution.js";
...
export function buildExecutionPlan({
  ...
  const fixtures = validateHostedDiagnosticFixtureManifest(fixtureManifest);
...
export async function executeApproved({
  ...
  const fixtureReview = validateHostedDiagnosticFixtureManifest(fixtureManifest);
