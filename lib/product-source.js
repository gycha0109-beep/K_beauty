...
async function fetchSupabaseProducts() {
  ...
  if (Object.keys(skippedByCategoryReason).length > 0) {
    writeSafeLog("warn", {
      ...
      dependency: "supabase",
      retryable: false,
      count: Object.keys(skippedByCategoryReason).length
    });
  }
