...
// Security projection remains owned by the byte-preserved core implementation:
// image_url: resolveSafeProductImage(product.image_url)
// mapCurrentProductOption also calls resolveSafeProductImage(product.image_url).
