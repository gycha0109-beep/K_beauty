...
function buildPremiumRoutine(topPick, supportingProducts, routineStructure, locale = "ko", answers = {}) {
...
export async function buildSkinMatchDecisionBundle(input, options = {}) {
  ...
  const premiumRoutine = buildPremiumRoutine(resolvedTopPick, supportingProducts, routineStructure, locale, answers);
  const premiumReport = {
