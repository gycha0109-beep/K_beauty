...
// A normal server-built Premium report exceeds 2,000 traversed entries after
// canonical decision-state projection. Keep a finite fail-closed ceiling while
// allowing that bounded application payload through the image projection.
const MAX_COLLECTION_ENTRIES = 4096;
