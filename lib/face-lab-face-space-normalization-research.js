...
} from "./face-lab-real-photo-stability-adequacy.js";

import {
  buildRealPhotoStabilityAdequacyReview
} from "./face-lab-real-photo-stability-adequacy-review.js";

import {
  validateRealPhotoStabilityAdequacyDecision
} from "./face-lab-real-photo-stability-adequacy-decision.js";
...
} from "./face-lab-reference-corpus-adequacy.js";
...
function normalizeReferenceCorpusEvidence(
  ...
  if (
    ...
    if (
      referenceCorpusReviewPacket !== undefined &&
      referenceCorpusReviewPacket !== null
    ) {
      throw new Error(
        "face_space_normalization_reference_corpus_review_packet_without_manifest"
      );
    }
    if (
      referenceCorpusAdequacyEvidence !== undefined &&
      referenceCorpusAdequacyEvidence !== null
    ) {
      throw new Error(
        "face_space_normalization_reference_corpus_adequacy_without_manifest"
      );
    }
    return {
      ...
      referenceCorpusAdequacyPresent: false,
      referenceCorpusAdequacyDecisionVersion: null,
      referenceCorpusReviewPacketFingerprint: null,
      structuralMultiSubjectCoverage: false,
      structuralGeneralFaceCoverage: false,
      structuralReferenceDistribution: false,
  ...
  const adequacy =
    ...
    referenceCorpusAdequacyEvidence !== null
      ...
      : null;
  const adequacyPresent =
    adequacy?.status === "adequate_for_provisional_research";
  const structuralMultiSubjectCoverage =
    evidenceState.multiSubjectCoverage === true;
  const structuralGeneralFaceCoverage =
    evidenceState.generalFaceSamplingFrame === true;
  const structuralReferenceDistribution =
  ...
  return {
    ...
    referenceCorpusAdequacyPresent: adequacyPresent,
    referenceCorpusAdequacyDecisionVersion:
      adequacy?.decisionVersion || null,
    referenceCorpusReviewPacketFingerprint:
      adequacy?.sourceReviewPacketFingerprint || null,
    structuralMultiSubjectCoverage,
    structuralGeneralFaceCoverage,
    structuralReferenceDistribution,
    multiSubjectCoverage:
      adequacyPresent && structuralMultiSubjectCoverage,
    generalFaceCoverage:
      adequacyPresent && structuralGeneralFaceCoverage,
    referenceDistribution:
      adequacyPresent && structuralReferenceDistribution,
    lockedHoldoutPresent
  };
}
...
function normalizeEvidenceState(
  ...
  if (
    realPhotoStabilityReports === undefined ||
    realPhotoStabilityReports === null
  ) {
    if (
      realPhotoStabilityReviewPacket !== undefined &&
      realPhotoStabilityReviewPacket !== null
    ) {
      throw new Error(
        "face_space_normalization_real_photo_review_packet_without_reports"
      );
    }
    if (
      realPhotoStabilityAdequacyEvidence !== undefined &&
      realPhotoStabilityAdequacyEvidence !== null
    ) {
      throw new Error(
        "face_space_normalization_real_photo_adequacy_without_reports"
      );
    }
    if (
      realPhotoStabilityAdequacyDecision !== undefined &&
      realPhotoStabilityAdequacyDecision !== null
    ) {
      throw new Error(
        "face_space_normalization_real_photo_decision_without_reports"
      );
    }
  }
  ...
  if (
    ...
    throw new Error(
      "face_space_normalization_real_photo_adequacy_mode_ambiguous"
    );
  }
  ...
  const realPhotoAdequacy =
    ...
    realPhotoStabilityAdequacyEvidence !== null
      ...
      : null;
  const realPhotoDescriptiveReview =
    realPhotoCollection &&
    realPhotoStabilityAdequacyDecision !== undefined &&
    realPhotoStabilityAdequacyDecision !== null
      ? buildRealPhotoStabilityAdequacyReview(
      ...
      : null;
  const realPhotoDecision =
    realPhotoDescriptiveReview
      ? validateRealPhotoStabilityAdequacyDecision(
          realPhotoStabilityAdequacyDecision,
          realPhotoDescriptiveReview
        )
      : null;
  const realPhotoAdequacyPresent =
    realPhotoDecision
      ? realPhotoDecision.status ===
          "adequate_for_provisional_research" &&
        realPhotoDecision.provisionalResearchGateGranted === true
      : realPhotoAdequacy?.status ===
          "adequate_for_provisional_research";
  const structuralRealPoseEvidenceKind =
    realPhotoCollection?.readinessContribution?.realPoseEvidenceKind || null;
  const structuralRealExpressionEvidenceKind =
    realPhotoCollection?.readinessContribution?.realExpressionEvidenceKind ||
    null;
  const realPoseEvidenceKind =
    realPhotoAdequacyPresent ? structuralRealPoseEvidenceKind : null;
  const realExpressionEvidenceKind =
    realPhotoAdequacyPresent ? structuralRealExpressionEvidenceKind : null;
  ...
  return {
    ...
    referenceCorpusAdequacyPresent:
      corpusEvidence.referenceCorpusAdequacyPresent,
    referenceCorpusAdequacyDecisionVersion:
      corpusEvidence.referenceCorpusAdequacyDecisionVersion,
    referenceCorpusReviewPacketFingerprint:
      corpusEvidence.referenceCorpusReviewPacketFingerprint,
    structuralMultiSubjectCoverage:
      corpusEvidence.structuralMultiSubjectCoverage,
    structuralGeneralFaceCoverage:
      corpusEvidence.structuralGeneralFaceCoverage,
    structuralReferenceDistribution:
      corpusEvidence.structuralReferenceDistribution,
    ...
    realPhotoStabilityCollectionFingerprint:
      realPhotoCollection?.collectionFingerprint || null,
    realPhotoStabilityAdequacyPresent:
      realPhotoAdequacyPresent,
    realPhotoStabilityAdequacyDecisionVersion:
      realPhotoDecision?.decisionVersion ||
      realPhotoAdequacy?.decisionVersion ||
      null,
    ...
    realPhotoStabilityAdequacyDecisionCode:
      realPhotoDecision?.decisionCode || null,
    realPhotoStabilityProvisionalResearchGateGranted:
      realPhotoAdequacyPresent,
    realPhotoStabilityAdequacyHoldReasons:
      realPhotoDecision?.holdReasons || [],
    realPhotoStabilityEvidenceIntegrityBlockers:
      realPhotoDecision?.evidenceIntegrityBlockers || [],
    realPhotoStabilityDescriptiveReviewFingerprint:
      realPhotoDescriptiveReview?.analysisFingerprint || null,
    realPhotoStabilityReviewPacketFingerprint:
      realPhotoDecision?.sourceReviewPacketFingerprint ||
      realPhotoAdequacy?.sourceReviewPacketFingerprint ||
      null,
    structuralRealPhotoCoveredNuisanceClasses:
      realPhotoCollection?.coveredNuisanceClasses || [],
...
export function evaluateFaceSpaceNormalizationReadiness({
  ...
  const blockers = [];
  if (
    stabilitySummary.fixture?.distinctSubjectCount === 1 &&
    !state.referenceCorpusManifestPresent &&
    state.realPhotoStabilityReportCount === 0
  ) {
    blockers.push("single_fixture_only");
  }
  if (
    state.referenceCorpusManifestPresent &&
    !state.referenceCorpusAdequacyPresent
  ) {
    blockers.push("reference_corpus_adequacy_missing");
  }
  ...
  if (
    state.realPhotoStabilityReportCount > 0 &&
    !state.realPhotoStabilityAdequacyPresent
  ) {
    if (
      state.realPhotoStabilityAdequacyDecisionStatus ===
      "hold_for_more_evidence"
    ) {
      blockers.push(
        "real_photo_stability_additional_evidence_required"
      );
      for (const reason of state.realPhotoStabilityAdequacyHoldReasons) {
        blockers.push("real_photo_stability_hold:" + reason);
      }
    } else if (
      state.realPhotoStabilityAdequacyDecisionStatus ===
      ...
      blockers.push(
        "real_photo_stability_evidence_integrity_blocked"
      );
      for (
        const reason of
        state.realPhotoStabilityEvidenceIntegrityBlockers
      ) {
        blockers.push(
          "real_photo_stability_integrity_block:" + reason
        );
      }
    } else {
      blockers.push("real_photo_stability_adequacy_missing");
    }
  }
  ...
  const structurallyCoveredNuisanceClasses = new Set(
    state.structuralRealPhotoCoveredNuisanceClasses
  );
  const governedReplacementSatisfied = (requirement) => {
    if (requirement === "general_face_coverage") {
      return state.generalFaceCoverage;
    }
    if (requirement === "population_or_reference_distribution") {
      return state.referenceDistribution;
    }
    if (requirement === "expression_real_same_subject_pair") {
      return structurallyCoveredNuisanceClasses.has("expression");
    }
    if (requirement === "head_yaw_real_same_subject_pair") {
      return structurallyCoveredNuisanceClasses.has("head_yaw");
    }
    if (requirement === "head_pitch_real_same_subject_pair") {
      return structurallyCoveredNuisanceClasses.has("head_pitch");
    }
    if (requirement === "head_roll_real_same_subject_pair") {
      return structurallyCoveredNuisanceClasses.has("head_roll");
    }
    return false;
  };
  for (const requirement of REQUIRED_STABILITY_EVIDENCE) {
    if (
      unresolved.has(requirement) &&
      !governedReplacementSatisfied(requirement)
    ) {
