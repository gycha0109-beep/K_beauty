...
import { SHARED_SKIN_DECISION_CONTEXT_VERSION } from "./shared-skin-decision-context-v4.js";
...
export function validateCandidatePolicyCurrentFindingsContext(context) {
  ...
  if (context.source !== CONTEXT_SOURCE) errors.push("candidate_current_findings_context_source_invalid");
  ...
  if (!Array.isArray(context.findings)) errors.push("candidate_current_findings_rows_invalid");
