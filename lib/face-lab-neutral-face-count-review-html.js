...
<section id="review" class="card hidden">
  ...
  <div class="status">사진의 분위기나 인상을 평가하지 말고, 화면에서 사람 얼굴로 식별되는 얼굴 수만 확인해 주세요.</div>
  <img id="image" class="image" alt="얼굴 수를 확인할 사진">
