...
export function buildEvaluatorBoundaryPolicyRuntime({
  ...
  return {
    ...
    currentFindingsContextVersion: execution.currentFindingsContextVersion,
    currentFindingsExposureState: execution.currentFindingsExposureState,
    currentFindingsCount: execution.currentFindingsCount,
    currentFindingsEvaluableCount: execution.currentFindingsEvaluableCount,
    currentFindingsUnknownCount: execution.currentFindingsUnknownCount,
