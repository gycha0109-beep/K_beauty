export const STYLE_ROUTE_GENERATOR_VERSION = "face-lab-style-route-v6";
...
function createRoute(strategy, actions, locale, targetStyle = null, activeTargetAxes = new Set()) {
  ...
  if (Number.isFinite(dailyMinutes) && dailyMinutes <= 5) {
    if (dailyEffort === "high") {
      softTradeoffs.push("daily_time_constraint_5");
      constraintScore -= 2;
    }
    ...
    softTradeoffs.push("daily_time_constraint_15");
    constraintScore -= 1;
  }
