...
const DEFAULT_THRESHOLDS = Object.freeze({
  ...
  maxFaceHeightRatio: 1.04,
  maxFaceWidthRatio: 1.03,
  maxPitchRatio: 0.63,
  maxRollDegrees: 10,
  minFaceHeightRatio: 0.68,
  minFaceWidthRatio: 0.62,
  minPitchRatio: 0.26,
  minYawSymmetry: 0.6,
  ovalInset: 0.98
});
...
function getFrontalMetrics(landmarks, frame) {
  ...
  const rollDegrees = Math.abs((rollRadians * 180) / Math.PI);
...
export const FACE_GUIDE_THRESHOLDS = DEFAULT_THRESHOLDS;
