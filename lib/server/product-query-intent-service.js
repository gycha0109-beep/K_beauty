...
- When the query contains incompatible positive and negative preferences for the same semantic dimension, do not choose a side. Neutralize the affected structured field(s) to null, preserve a short conflict phrase in unresolved_terms, set confidence to low, and keep conflicted fields out of ranking signals. In particular, rejecting tone-up while also asking for the face/complexion to become brighter is a tone_up_wanted conflict: tone_up_wanted MUST be null, never true or false.
