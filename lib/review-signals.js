...
export function getReviewSignalCategoryFamily(category) {
  const normalized = normalizeCategoryKey(category);
  return REVIEW_SIGNAL_CATEGORY_FAMILY_MAP[normalized] || null;
}
...
function resolveReviewSignalCategoryFamily(options = {}, parsed = {}) {
  ...
  return getReviewSignalCategoryFamily(options.category || parsed.category);
}
