...
export const PRODUCT_QUERY_PRODUCTION_CANARY_MAX_WINDOW_MINUTES = 360;
...
export function parseApprovedProductQueryCanaryAccountHashes(value) {
  const raw = String(value ?? "").trim();
...
export function evaluateProductQueryProductionCanaryPreflight(envLike = {}) {
  ...
  const approvedAccountHashes =
    parseApprovedProductQueryCanaryAccountHashes(envLike.BEJEWELY_PRODUCT_QUERY_PRODUCTION_APPROVED_ACCOUNT_HASHES);
  const windowStartMs =
