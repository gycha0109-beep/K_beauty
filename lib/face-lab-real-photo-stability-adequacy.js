...
export function validateRealPhotoStabilityAdequacyEvidence(
  ...
  if (
    ...
    reviewPacket.sourceReportCount !== collectionSummary.reportCount ||
    !sameStringSet(
      reviewPacket.sourceRunManifestDigests,
