...
export function buildPremiumSessionReportSource({ premiumReport, decision, freeResult }) {
  ...
  return {
    ...
    photoEvidenceState: decision.photoEvidenceState || freeResult?.photoEvidenceState || null,
    imageEligibility: decision.imageEligibility || freeResult?.imageEligibility || null,
    fullRoutine: {
