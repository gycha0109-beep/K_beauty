...
async function resolveDiaryDayAuth(authContext) {
...
export async function getMyDiaryDayPayload({ date, authContext } = {}) {
  ...
  const resolvedAuth = await resolveDiaryDayAuth(authContext);
