...
begin
    ...
    extensions.digest(
      convert_to(
        jsonb_build_object(
          ...
          'support_direction', v_old_candidate.support_direction,
          'negative_admissibility', v_old_candidate.negative_admissibility,
  ...
  insert into public.trust_evidence_candidates (
    ...
    v_old_candidate.support_direction,
    v_old_candidate.negative_admissibility,
