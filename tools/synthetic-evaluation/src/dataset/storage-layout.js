...
export const datasetStorageLayout = Object.freeze({
  ...
  exposureSuccessorClaim: (lineageId, fingerprint, predecessorDigest) => path.posix.join("datasets", "exposure-successor-claims", lineageId, fingerprint, `${predecessorDigest || "root"}.json`),
