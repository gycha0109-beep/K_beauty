...
export const HOSTED_FAILURE_CATEGORIES = Object.freeze({
  ...
  PREVIEW_ATTESTATION: "PREVIEW_ATTESTATION_FAILURE",
  CREDENTIAL_STORAGE: "CREDENTIAL_STORAGE_FAILURE",
  AUTH_EVIDENCE: "AUTH_EVIDENCE_FAILURE",
  FIXTURE_CONTRACT: "FIXTURE_CONTRACT_FAILURE",
  CANONICAL_PROJECTION: "CANONICAL_PROJECTION_FAILURE"
});
