...
async function main() {
  ...
  process.stdout.write(
    [
      ...
      '4. Build a fixture with: node scripts/build-review-signal-fixture.mjs --input data/hwahae-review-signals/samples/single/hwahae-raw.single.json --out data/hwahae-review-signals/samples/single/hwahae-review-signals.single.fixture.json',
      '5. Dry-run import with: node scripts/import-review-signals-to-supabase.mjs --file data/hwahae-review-signals/samples/single/hwahae-review-signals.single.fixture.json --dry-run',
