...
const [rollRunPath, reviewPacketPath, contractPath] =
  process.argv.slice(2);
assert.ok(
  rollRunPath && reviewPacketPath && contractPath,
  "Usage: node scripts/verify-face-lab-complete-stability-evidence.mjs <roll-run.json> <review-packet.json> <contract.json>"
);
