...
assert.match(copySource, /분석을 실행하기 전까지 기기에만 유지됩니다/, "Korean pre-submit local photo disclosure is missing");
assert.match(copySource, /stays on your device until you choose to run the analysis/i, "English pre-submit local photo disclosure is missing");
...
assert.match(androidSmokeSource, /wait_for_text "TAKE A CLEAR SKIN PHOTO"/, "Android smoke must observe the rendered fullscreen Analyze title");
