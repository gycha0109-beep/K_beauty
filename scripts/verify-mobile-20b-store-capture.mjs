...
const screens = [
  ["results-en", "03-results-en-1080x1920.png", "03-results-en-window.xml", ["Your skin routine, made clear", "PERSONALIZED RESULT", "TOP PICK", "Start with this match", "닥터지", "Home", "Analyze", "My"]],
  ...
  ["results-ko", "03-results-ko-1080x1920.png", "03-results-ko-window.xml", ["내 피부에 맞는 루틴을 한눈에", "PERSONALIZED RESULT", "TOP PICK", "가장 먼저 시작할 제품", "1순위 추천", "닥터지", "홈", "분석", "마이"]],
