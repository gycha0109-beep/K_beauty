...
assert.ok(routeSource.includes("buildFaceLabObservationAnalysis as buildObservationAnalysis"));
assert.ok(routeSource.includes("const analysis = buildObservationAnalysis("));
