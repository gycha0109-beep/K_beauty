...
assert.ok(
  expressionRunPath &&
    ...
    reviewPacketOutputPath &&
    contractOutputPath,
  "Usage: node scripts/build-face-lab-complete-stability-evidence.mjs <expression-run.json> <yaw-run.json> <pitch-run.json> <roll-run.json> <contract-input.json> <review-packet-output.json> <contract-output.json>"
);
