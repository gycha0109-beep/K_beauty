...
wait_for_text "Skincare that fits your skin"
wait_for_text "Start with your skin"
adb exec-out screencap -p > "$ARTIFACT_DIR/home-light-en.png"

tap_text "Analyze"
wait_for_text "SKIN PHOTO"
