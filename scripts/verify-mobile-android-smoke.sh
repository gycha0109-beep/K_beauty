...
# Cold start must therefore land directly in the Analyze camera flow.
...
# Initial routing is cold-start-only. Home remains directly accessible later
# in the same runtime even when the user has no saved report yet.
tap_text "Home"
