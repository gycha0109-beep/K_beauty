...
requireText(
  ...
  "same-runtime-home-focus-release"
);
requireText(home, "if (!homeReady) {", "resolved-home-render-gate");
requireText(
  home,
...
requireText(iosSmoke, 'assert_screenshot_contains "$INITIAL_SCREENSHOT" "Camera ready"', "ios-cold-start-analyze-ocr");
