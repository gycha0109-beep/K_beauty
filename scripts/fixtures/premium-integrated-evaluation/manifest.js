...
export const fixtureManifest = {
  ...
  scenarios: [
    ...
    scenario("S14_STABILIZATION_FALLBACK_BYPASS_ATTEMPT", "Fallback bypass attempt", { ...sensitiveReport(active, { recentSkinChange: "yes", sensitivity: "high" }), topPick: { id: "stale-top", category: "treatment" }, budgetAlternatives: [{ id: "stale-budget", category: "treatment" }], conditionResponses: [{ responseKey: "active_load", status: "avoid_for_now", legacyCarryover: true }] }, { projections: [{ path: "functionalPlan.productCandidates", operator: "length_equals", expected: 0 }, { path: "functionalPlan.budgetAlternatives", operator: "length_equals", expected: 0 }], invariants: [...common, "RAW_POLICY_IMMUTABILITY", "FALLBACK_PROJECTION_ENFORCEMENT"] }, { catalogProducts: [active] }),
